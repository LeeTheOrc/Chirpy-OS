...
import { SendIcon, RocketLaunchIcon, ScrollIcon, SparklesIcon, FlameIcon, ComputerDesktopIcon, PackageIcon, KeyIcon, TowerIcon, FolderIcon, ShieldCheckIcon, BookOpenIcon, QuestionMarkIcon, CompletedGrimoireIcon, ServerStackIcon, SignalIcon, EyeIcon, LinkIcon } from './Icons';
    ...
    return (
        <div className="bg-forge-panel/90 backdrop-blur-sm border-t-2 border-forge-border rounded-t-xl mt-auto pb-4 px-4 pt-2 shadow-2xl shadow-black/30">
             ...
             <div className="flex items-center justify-center gap-2 p-2 flex-wrap border-b-2 border-forge-border/50 mb-2">
                ...
                <TooltipButton title="Attune WebDisk Client" onClick={() => onOpenMenu('webDiskAttunement')} colorClass="text-sky-400"><LinkIcon className="w-5 h-5" /></TooltipButton>
