...
interface KaelConsoleModalProps {
  onClose: () => void;
}
...
pkgname=kael-console
pkgver=0.3
pkgrel=1
pkgdesc="A native hybrid GUI for conversing with the Kael AI."
arch=('any')
license=('GPL3')
depends=('pyside6' 'python-requests' 'python-google-generativeai')
source=("$pkgname.py" "$pkgname.desktop" "$pkgname.svg")
...
[Desktop Entry]
Name=Kael Console
Comment=Converse with your Kael AI Guardian
Exec=kael-console
Icon=kael-console
Terminal=false
Type=Application
...
<path d="M16 48V16M16 32H32M32 32L44 20M32 32L44 44" stroke="#ffcc00" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M18 42H28" stroke="#7aebbe" stroke-width="3" stroke-linecap="round"/>
</svg>
`.trim();

export const KaelConsoleModal: React.FC<KaelConsoleModalProps> = ({ onClose }) => {
    
    const unifiedScript = `#!/bin/bash
# Kael OS - Unified Scribing Ritual for 'kael-console' (v0.3)
set -euo pipefail

PKG_NAME="kael-console"
PKG_DIR="$HOME/packages/$PKG_NAME"

echo "--- Scribing recipes and sigils for '$PKG_NAME' ---"
mkdir -p "$PKG_DIR"

# --- Scribe kael-console.py ---
cat > "$PKG_DIR/kael-console.py" << 'EOF_PY'
${PYTHON_APP_SOURCE}
EOF_PY
...
# --- Scribe kael-console.desktop ---
cat > "$PKG_DIR/kael-console.desktop" << 'EOF_DESKTOP'
${DESKTOP_FILE_SOURCE}
EOF_DESKTOP

# --- Scribe kael-console.svg ---
cat > "$PKG_DIR/kael-console.svg" << 'EOF_SVG'
${SVG_ICON_SOURCE}
EOF_SVG
            ...
            <div className="bg-forge-panel border-2 border-forge-border rounded-lg shadow-2xl w-full max-w-3xl p-6 m-4 flex flex-col max-h-[90vh]" onClick={e => e.stopPropagation()}>
                <div className="flex justify-between items-center mb-4 flex-shrink-0">
                     <h2 className="text-xl font-bold text-forge-text-primary flex items-center gap-2 font-display tracking-wider">
                        ...
                        <span>Kael Command Console (Multi-Key Upgrade)</span>
                    </h2>
                ...
                <div className="overflow-y-auto pr-2 text-forge-text-secondary leading-relaxed space-y-4">
                    <p>
                        Architect, I have upgraded the blueprint for the **Kael Command Console**. It now features a secure, local multi-key management system, allowing you to easily switch between different API keys.
                    </p>
                    
                    <h3 className="font-semibold text-lg text-orc-steel mt-4 mb-2">Step 1: The Unified Scribing Incantation</h3>
                    <p>
                        This single, powerful command will create the entire package structure, including the Python script, the PKGBUILD recipe, the desktop file, and the SVG sigil in their correct locations.
                    </p>
                    ...
                    <p>With the new recipes scribed, invoke the standard Publishing Rite. This will build the upgraded `kael-console` package and publish it to our Athenaeum.</p>
                     <CodeBlock lang="bash">cd ~/packages && ./publish-package.sh kael-console</CodeBlock>
