...
export const CpuChipIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75h.008v.008H12V6.75zm0 3.75h.008v.008H12v-.008zm0 3.75h.008v.008H12v-.008zm0 3.75h.008v.008H12v-.008zM9.75 9.75h.008v.008H9.75V9.75zm0 3.75h.008v.008H9.75v-.008zm0 3.75h.008v.008H9.75v-.008zm0 3.75h.008v.008H9.75v-.008zM14.25 9.75h.008v.008H14.25V9.75zm0 3.75h.008v.008H14.25v-.008zm0 3.75h.008v.008H14.25v-.008zm0 3.75h.008v.008H14.25v-.008z" />
  </svg>
);
...
export const MemoryStickIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3v3.75m9-3.75v3.75" />
  </svg>
);
...
export const CodeBracketIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 7.5l-3.8-3.8a.75.75 0 00-1.06 1.06L5.69 8.5 1.89 12.3a.75.75 0 001.06 1.06l3.8-3.8zm10.5 0l3.8 3.8a.75.75 0 01-1.06 1.06L18.31 8.5l3.8 3.8a.75.75 0 01-1.06 1.06l-3.8-3.8z" />
  </svg>
);
...
export const PackageIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75L3 7.5M21 7.5L12 12.75" />
  </svg>
);
