...
# Kael OS - The True Ritual of Insight for 'khws'
set -euo pipefail
...
echo "--- Beginning the True Ritual of Insight for '$pkgname' ---"

# Step 0: Ensure the allied artisan's key is trusted
echo "--> Attuning to CachyOS artisan's signature..."
gpg --recv-key F3B607488DB35A47 && gpg --lsign-key F3B607488DB35A47 || echo "Key already trusted or attunement failed, proceeding..."
...
makedepends=('rust' 'cargo' 'git' 'pkg-config' 'pciutils')
            ...
            <div className="bg-forge-panel border-2 border-forge-border rounded-lg shadow-2xl w-full max-w-2xl p-6 m-4 flex flex-col max-h-[90vh]" onClick={e => e.stopPropagation()}>
                <div className="flex justify-between items-center mb-4 flex-shrink-0">
                     <h2 className="text-xl font-bold text-forge-text-primary flex items-center gap-2 font-display tracking-wider">
                        ...
                        <span>The True Ritual of Insight: Forge `khws`</span>
                    </h2>
                ...
                <div className="overflow-y-auto pr-2 text-forge-text-secondary leading-relaxed space-y-4">
                    <p>
                        You are right, Architect. The time for theory is over. This is the true ritual to forge our own branded hardware scrying tool, <strong className="text-dragon-fire">`khws`</strong>.
                    </p>
                    <p>
                        This unified incantation will:
                    </p>
                    <ul className="list-decimal list-inside text-sm pl-4 space-y-1">
                        <li>Ensure the CachyOS artisan's key is trusted, a necessary prerequisite.</li>
                        <li>Create the correct <strong className="text-orc-steel">PKGBUILD</strong> recipe for `khws` that properly replaces `chwd`.</li>
                        <li>Invoke our <strong className="text-orc-steel">publisher script</strong> to build, sign, and upload the finished package to our Athenaeum.</li>
                    </ul>
                    <h3 className="font-semibold text-lg text-orc-steel mt-4 mb-2">The Unified Incantation</h3>
                    <p>
                        Copy this single, powerful command and run it in your terminal. This is the correct path forward.
                    </p>
                    <CodeBlock lang="bash">{fullCommand}</CodeBlock>
                    <h3 className="font-semibold text-lg text-orc-steel mt-4 mb-2">What's Next?</h3>
                    <p>
                        Once this ritual is complete and `khws` is in our Athenaeum, *then* we can use the <strong className="text-magic-purple">Ritual of Transmutation</strong> to further modify its source code and truly make it our own.
                    </p>
                </div>
            </div>
        </div>
